...
ggsave(filename = paste0(opt$outfile,"metadata_countries_of_interest_plot_", Serotype, ".pdf"), plot = plot_1)
...
ggsave(filename = paste0(opt$outfile,"df_sample_location_of_interest_plot_", Serotype,".pdf"), plot = plot_2)
...
if (opt$sampling_method == 'Even') {
  ...
  ggsave(filename = paste0(opt$outfile,"background_sample_plot_even_", Serotype,".pdf"), plot = plot_4)
  ...
  ggsave(filename = paste0(opt$outfile,"background_metadata_plot_proportional_", Serotype, ".pdf"), plot = plot_5)
  ...
  ggsave(filename = paste0(opt$outfile,"background_sample_plot_proportional_", Serotype, ".pdf"), plot = plot_6)
